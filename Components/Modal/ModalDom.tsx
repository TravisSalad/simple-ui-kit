...
function handleKeyUp(e, props: ModalDomProps) {
...
function createHeader(props: ModalDomProps) {
    return (
        <HeaderWrapper>
            {props.title ? 
                <StyledTitle
...
export class ModalDom extends React.Component<ModalDomProps> {
    ...
    public componentWillReceiveProps(props: ModalDomProps): void {
        if (props.show) {
